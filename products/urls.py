...
urlpatterns = [
    ...
    url(r'^(?P<marketplace>[\w-]+)/istebu.xml', download_xml_streaming, name='products_xml'),
    # url(r'^test/(?P<marketplace>[\w-]+)/istebu.xml', download_xml_streaming, name='products_test_xml'),
