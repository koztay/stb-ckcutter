# -*- coding: utf-8 -*-
"""
Django settings for ecommerce_istebu_cookiecutter project.
...
LOCAL_APPS = [
    # custom users app
    'ecommerce_istebu_cookiecutter.users.apps.UsersConfig',
...
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgres:///ecommerce_istebu_cookiecutter'),
}
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            str(ROOT_DIR.path('templates_for_istebu')),  # buradaki sıralama önemli, override etmek için önce
            # ROOT_DIR'e bakması lazım.
...
STATICFILES_DIRS = [
    str(APPS_DIR.path('static_for_istebu')),
...
ACCOUNT_ADAPTER = 'ecommerce_istebu_cookiecutter.users.adapters.AccountAdapter'
SOCIALACCOUNT_ADAPTER = 'ecommerce_istebu_cookiecutter.users.adapters.SocialAccountAdapter'
...
########## CELERY
INSTALLED_APPS += ['ecommerce_istebu_cookiecutter.taskapp.celery.CeleryConfig']
